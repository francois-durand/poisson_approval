...
def test_best_response_anti_plurality():
    """
        ...
        duo_ij = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        duo_ij = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        duo_ji = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        duo_ik = <asymptotic = exp(- n*(-sqrt(30)/15 + sqrt(15)/5)**2 - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_ab = sqrt(2)/3, phi_ac = 1, phi_bc = 3*sqrt(2)/2>
        duo_ki = <asymptotic = exp(- n*(-sqrt(30)/15 + sqrt(15)/5)**2 - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_ab = sqrt(2)/3, phi_ac = 1, phi_bc = 3*sqrt(2)/2>
        ...
        pivot_weak_ij = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        pivot_weak_ji = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        ...
        pivot_strict_ij = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        pivot_strict_ji = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        ...
        pivot_tij_ijk = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + log(sqrt(2)/2 + 1) + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        pivot_tij_ikj = <asymptotic = exp(n*(-1 + 2*3**(2/3)/5) + ? log(n) + ? + o(1)), phi_ab = 2*3**(2/3)/9, phi_ac = 3**(2/3)/2, phi_bc = 3**(2/3)>
        pivot_tij_jik = <asymptotic = exp(- n*(-2*sqrt(15)/15 + sqrt(30)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + log(1 + sqrt(2)) + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        ...
        pivot_tjk_kij = <asymptotic = exp(- n*(-2*sqrt(15)/15 + sqrt(30)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + log(sqrt(2)/2 + 1) + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        pivot_tjk_kji = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + log(1 + sqrt(2)) + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
        pivot_tij = <asymptotic = exp(- n*(-sqrt(30)/15 + 2*sqrt(15)/15)**2 - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + log(sqrt(2)/2 + 1) + o(1)), phi_ab = 1, phi_ac = sqrt(2)/2, phi_bc = sqrt(2)>
