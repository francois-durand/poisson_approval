...
from poisson_approval.utils.Util import isnan, ballot_high_u, ballot_low_u, look_equal
...
class BestResponse:
    ...
    def ballot(self):
        ...
        elif look_equal(self.threshold_utility, 1):
            return ballot_low_u(self.ranking, self.voting_rule)
        elif look_equal(self.threshold_utility, 0, abs_tol=1E-9):
