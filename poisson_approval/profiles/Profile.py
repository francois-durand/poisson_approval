...
class Profile():
    ...
    def d_ranking_share(self):
        """
        Dictionary of the shares of rankings.
    ...
    def is_standardized(self):
        """Whether the profile is standardized.
        """
    ...
    def is_profile_condorcet(self):
        """Whether the profile is Condorcet.

        1. means there is a strict Condorcet winner, 0.5 means there are one or more weak Condorcet winner(s), 0. means
...
for my_ranking in RANKINGS:
    setattr(Profile, my_ranking, make_property_ranking_share(my_ranking, 'Share of voters with this ranking.'))
