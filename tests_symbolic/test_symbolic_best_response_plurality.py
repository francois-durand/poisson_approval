...
def test_best_response_plurality():
    """
        >>> tau = TauVector({'a': Fraction(9, 15), 'b': Fraction(4, 15), 'c': Fraction(2, 15)},
        ...                 symbolic=True, voting_rule=PLURALITY)
        ...
        duo_ik = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        duo_ki = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        duo_jk = <asymptotic = exp(n*(-2/5 + 4*sqrt(2)/15) - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_a = 1, phi_b = sqrt(2)/2, phi_c = sqrt(2)>
        duo_kj = <asymptotic = exp(n*(-2/5 + 4*sqrt(2)/15) - log(n)/2 - log(8*sqrt(2)*pi/15)/2 + o(1)), phi_a = 1, phi_b = sqrt(2)/2, phi_c = sqrt(2)>
        ...
        pivot_weak_ik = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        pivot_weak_ki = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        ...
        pivot_strict_ik = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        pivot_strict_ki = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        ...
        pivot_tij_ikj = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + log(sqrt(2)/3 + 1) + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        ...
        pivot_tij_kij = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + log(1 + 3*sqrt(2)/2) + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        ...
        pivot_tjk_jik = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + log(sqrt(2)/3 + 1) + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
        pivot_tjk_jki = <asymptotic = exp(n*(-11/15 + 2*sqrt(2)/5) - log(n)/2 - log(4*sqrt(2)*pi/5)/2 + log(1 + 3*sqrt(2)/2) + o(1)), phi_a = sqrt(2)/3, phi_b = 1, phi_c = 3*sqrt(2)/2>
